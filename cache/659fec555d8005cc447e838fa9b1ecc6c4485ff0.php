               ...
               <div class="header-message-list p-2">
                   <a class="dropdown-item" href="#">
                     <div class="d-flex align-items-center">
                        <img src="/lk/assets/images/avatars/avatar-1.png" alt="" class="rounded-circle" width="50" height="50">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="/lk/assets/images/avatars/avatar-2.png" alt="" class="rounded-circle" width="50" height="50">
                       <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="/lk/assets/images/avatars/avatar-3.png" alt="" class="rounded-circle" width="50" height="50">
                       <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="/lk/assets/images/avatars/avatar-4.png" alt="" class="rounded-circle" width="50" height="50">
                       <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="/lk/assets/images/avatars/avatar-5.png" alt="" class="rounded-circle" width="50" height="50">
                       <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="/lk/assets/images/avatars/avatar-6.png" alt="" class="rounded-circle" width="50" height="50">
                       <div class="ms-3 flex-grow-1">
            ...
            <li class="nav-item dropdown dropdown-user-setting">
              <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                <div class="user-setting d-flex align-items-center">
                  <img src="/lk/assets/images/avatar/default.svg" class="user-img" alt="">
                  <div class="">
                    <p><?php echo e($_SESSION['sur_name']); ?> <?php echo e($_SESSION['first_name']); ?> <?php echo e($_SESSION['last_name']); ?></p>
                    <p>Статус: <?php echo e($_SESSION['user_type-t']); ?></p>
                  </div>
                </div>
              </a>
                ...
                <li>
                    <a class="dropdown-item" href="/panel">
                       <div class="d-flex align-items-center">
                         ...
                         <div class="ms-3"><span>Кабинет</span></div>
                       </div>
                     </a>
                  </li>
                  <li>

        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table align-middle">
              ...
              <tbody>
                ...
                $result = $mysql->query("SELECT * FROM works WHERE work_user_name = '$work_user_nameC' AND
                  work_user_surname = '$work_user_surnameC' AND work_user_patronymic = '$work_user_patronymicC'");
          ...
          <div class="col-12 col-lg-2 d-flex">
            <div class="card w-100">
              ...
              <div class="card-body">
                <form class="row g-3" action="../module/delete.php" id="deleteWork" method="POST">
                  <div class="col-12">
                    <label class="form-label">№ работы</label>
                    <input name="idc2" id="idc2" type="text" class="form-control">
                  </div>
                  <div class="col-12">
                    <div class="d-grid">

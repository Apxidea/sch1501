                        ...
                        <div class="row align-items-center">
                            <div class="contact-block">
                                <div class="d-flex justify-content-between flex-wrap mt-3 align-items-center">
                                    ...
                                    <div style="font-size: 16px" class="fs-14px fw-bolder"> {{ $_COOKIE['user_email'] }}</div>
                                </div>
                                <div class="d-flex justify-content-between flex-wrap mt-2 align-items-center">
                                    ...
                                    <div style="font-size: 16px" class="fs-14px fw-bolder"> {{ $_COOKIE['user_phone'] }}</div>
                                </div>
                                <div class="d-flex justify-content-between flex-wrap mt-2 align-items-center">
                                    <span style="font-size: 16px" class="text-muted fw-bold">Школа</span>
                                    <div style="font-size: 16px" class="fs-14px fw-bolder"> {{ $_COOKIE['sch_name'] }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
